...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        default=str(PROJECT_ROOT / "data" / "processed" / "experiments" / "pick_strategy_stability_summary.json"),
    ...
    tuning_model_path = output_path.parent / "pick_strategy_stability_tuning.txt"
    final_model_path = output_path.parent / "pick_strategy_stability_final.txt"
